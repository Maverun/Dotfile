...
--vim.api.nvim_command("hi blue cterm=italic")
ls.config.setup({
    ext_opts = {
        [types.insertNode] = {
            active = {
...
local function window_for_choiceNode(choiceNode)
    ...
    local extmark = vim.api.nvim_buf_set_extmark(buf,current_nsid,row_selection - 1,0,
        {hl_group = 'incsearch',end_line = row_selection})

	-- shows window at beginning of choiceNode.
